...
var client_pid=_mlist[_ids.client].table_id;;
var sql_client=_config.parameters.sql_client;
//-------------------------------------
var _task_fields='';
//-------------------------------------
_set_req=function(){
    ...
    var sql="with client as (select clientUID=UID,sql_client="+_module.var.sql_client+" from [FORM-"+client_pid+"] "+client_where+" )";
